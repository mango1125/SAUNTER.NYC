...
function init() {
    ...
    controls.maxPolarAngle = Math.PI / 1.6; // Prevent looking underneath

    // Set zoom limits
    controls.minDistance = 1700; // Starting position is the furthest out you can zoom
    controls.maxDistance = 8000; // Prevent zooming out further
